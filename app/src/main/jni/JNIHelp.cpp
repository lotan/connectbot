...
/**
 * Equivalent to ScopedLocalRef, but for JNIEnv instead. (And slightly more powerful.)
 */
template<typename T>
...
extern "C" int jniThrowException(JNIEnv* c_env, const char* className, const char* msg) {
